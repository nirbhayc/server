...
void JOIN_TAB::remove_redundant_bnl_scan_conds(THD *thd)
{
  ...
  */
  ...
  if (is_cond_and(select_cond))
  {
    ...
    Item *pushed_item;
    Item_cond_and *reduced_select_cond= new Item_cond_and(thd);
...
make_join_readinfo(JOIN *join, ulonglong options, uint no_jbuf_after)
{
       ...
       tab= next_linear_tab(join, tab, WITH_BUSH_ROOTS))
  {
    ...
    */
    ...
    tab->remove_redundant_bnl_scan_conds(join->thd);
    DBUG_EXECUTE("where",
                 char buff[256];
